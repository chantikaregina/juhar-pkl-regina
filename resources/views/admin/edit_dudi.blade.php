        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            <form action="{{ route('admin.dudi.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_dudi" name="nama_dudi" value="{{ old('email', $dudi->nama_dudi) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="alamat_dudi" name="alamat_dudi" value="{{ old('email', $dudi->alamat_dudi) }}">
                    <div class="text-danger">
                        @error('alamat_dudi')
                        {{ $message }}
